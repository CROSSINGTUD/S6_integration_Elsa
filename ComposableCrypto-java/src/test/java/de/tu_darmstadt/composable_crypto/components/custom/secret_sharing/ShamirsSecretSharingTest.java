package de.tu_darmstadt.composable_crypto.components.custom.secret_sharing;
...
public class ShamirsSecretSharingTest {
    ...
    @BeforeEach
    public void setup() {
        scheme = ShamirsSecretSharing.builder().build();
    }
    ...
    @Test
    public void testShareAndReconstructShortMessage() throws SecretSharingScheme.InvalidSharesException {
        testShareAndReconstructStringMessage(10, 5, "Hello world!");
    }

    @Test
    public void testShareAndReconstructLongerMessage() throws SecretSharingScheme.InvalidSharesException {
    ...
    @Test
    public void testShareAndReconstructUnalignedMessageWithMultipleBlocks() throws SecretSharingScheme.InvalidSharesException {
    ...
    @Test
    public void testShareAndReconstructUnalignedMessageWithOnlyOneBlock() throws SecretSharingScheme.InvalidSharesException {
    ...
    @Test
    public void testShareAndReconstructAlignedMessageWithWholePaddingBlock() throws SecretSharingScheme.InvalidSharesException {
    ...
    private void testShareAndReconstruct(int n, int t, byte[] data) throws SecretSharingScheme.InvalidSharesException {
    ...
    private void testShareAndReconstructStringMessage(int n, int t, String message) throws SecretSharingScheme.InvalidSharesException {
